...
class Face_Register:
    def __init__(self):
        person_num_list_id = []
        if os.listdir("./Server/data/data_faces_from_camera/"):
            # 获取已录入的最后一个人脸序号 / Get the order of latest person
            person_list = os.listdir("./Server/data/data_faces_from_camera/")
            person_num_list = []
    ...
    def pre_work_mkdir(self):
        ...
        if os.path.isdir("./Server/"+self.path_photos_from_camera):
            pass
        else:
            os.mkdir("./Server/"+self.path_photos_from_camera)
    ...
    def save_current_face(self):
        ...
        if name_folder != "":
            count_images = 0
            if os.listdir(f"./Server/data/data_faces_from_camera/{name_folder}/"):
                images = os.listdir(f"./Server/data/data_faces_from_camera/{name_folder}/")
